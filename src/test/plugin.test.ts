...
describe('AsyncAPI EventCatalog Plugin', () => {
  describe('service generation', () => {
    ...
    describe('messages', () => {
      ...
      it('any message using the custom `ec-message-ownership` does not create new or modify existing message. but will be included in service documentation', async () => {
        const { getEvent } = utils(catalogDir);
        const { getService } = utils(catalogDir);
